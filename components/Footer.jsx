...
const Footer = () => {
  return (
    <footer className="bg-[#232127] ">
      <div className="flex flex-col justify-center items-center py-[55px] lg:flex-row lg:justify-between lg:items-start lg:py-[72px] lg:px-10 lg:mx-auto xl:px-[165px] xl:max-w-[1440px]">
