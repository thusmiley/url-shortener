...
const HomeHero = () => {
  return (
    <section className="pt-[115px] pb-[90px] overflow-hidden w-full lg:flex lg:flex-row-reverse lg:items-center lg:justify-between lg:pt-[23px] lg:pb-[68px] hero-bg-xl xl:pl-[165px] xl:max-w-[1536px] xl:mx-auto xl:pt-[78px]">
      <Image src={heroBg} alt="illustration of a person using a computer" className="h-auto w-full object-cover object-left ml-6 md:object-contain md:object-center md:mx-8 lg:ml-0 lg:mr-[-250px] max-h-[482px] xl:hidden" />
